import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, shallowRef, unref, watchEffect, markRaw, provide, Suspense, Transition, useSSRContext, mergeProps, withCtx, createVNode, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
const appHead = { "meta": [{ "name": "description", "content": "Everything about Nuxt 3" }], "link": [{ "rel": "stylesheet", "href": "https://fonts.googleapis.com/icon?family=Material+Icons" }], "style": [], "script": [], "noscript": [], "title": "Nuxt 3 Demo Store", "charset": "utf-8", "viewport": "width=device-width, initial-scale=1" };
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card" }, _attrs))}><div class="grid lg:grid-cols-2 gap-10 md:grid-cols-1"><div class="p-7"><img${ssrRenderAttr("src", `${__props.product.image}`)} class="sm:max-w-sm md:max-w-10 my-7"></div><div class="p-7"><h2 class="text-4xl my-7">${ssrInterpolate(__props.product.title)}</h2><p class="text-xl my-7">Price - $${ssrInterpolate(__props.product.price)}</p><h3 class="font-bold border-b-2 mb-4 pb-2">Product description:</h3><p class="mb-7">${ssrInterpolate(__props.product.description)}</p><button class="btn flex"><i class="material-icons mr-2">add_shopping_cart</i><span>Add to cart</span></button></div></div></div>`);
    };
  }
};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about.962b9b97.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.f701bafe.js").then((m) => m.default || m)
  },
  {
    name: "products-id",
    path: "/products/:id",
    ...
    component: () => import("./_nuxt/_id_.fb7f2d8a.js").then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    ...
    component: () => import("./_nuxt/index.dbf180dd.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.3f0521d7.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default.c1cb339e.js").then((m) => m.default || m)),
  products: defineAsyncComponent(() => import("./_nuxt/products.01d82086.js").then((m) => m.default || m))
};
