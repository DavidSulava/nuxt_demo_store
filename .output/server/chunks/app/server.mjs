import { getCurrentInstance, inject, computed, defineComponent, provide, h, Suspense, Transition, reactive, defineAsyncComponent, isRef, ref, resolveComponent, watchEffect, markRaw, mergeProps, useSSRContext, withCtx, createVNode, shallowRef, createApp, toRef, onErrorCaptured, unref } from 'vue';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense } from 'vue/server-renderer';
...
const appHead = { "meta": [{ "name": "description", "content": "Everything about Nuxt 3" }], "link": [{ "rel": "stylesheet", "href": "https://fonts.googleapis.com/icon?family=Material+Icons" }], "style": [], "script": [], "noscript": [], "title": "Nuxt Demo Store", "charset": "utf-8", "viewport": "width=device-width, initial-scale=1" };
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card" }, _attrs))} data-v-be018079><div class="grid grid-cols-2 gap-10" data-v-be018079><div class="p-7" data-v-be018079><img${ssrRenderAttr("src", `${__props.product.image}`)} class="mx-auto my-7" data-v-be018079></div><div class="p-7" data-v-be018079><h2 class="text-4xl my-7" data-v-be018079>${ssrInterpolate(__props.product.title)}</h2><p class="text-xl my-7" data-v-be018079>Price - $${ssrInterpolate(__props.product.price)}</p><h3 class="font-bold border-b-2 mb-4 pb-2" data-v-be018079>Product description:</h3><p class="mb-7" data-v-be018079>${ssrInterpolate(__props.product.description)}</p><button class="btn flex" data-v-be018079><i class="material-icons mr-2" data-v-be018079>add_shopping_cart</i><span data-v-be018079>Add to cart</span></button></div></div></div>`);
    };
  }
};
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-be018079"]]);
const meta$1 = {
  layout: "products"
};
const _sfc_main$2 = {
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-f42ba0d0"]]);
const meta = {
  layout: "products"
};
const _routes = [
  {
    name: "about",
    path: "/about",
    file: "/home/david/Programming/Personal/Store_On_Nuxt_3/pages/about.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./_nuxt/about.58d5d3e3.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "/home/david/Programming/Personal/Store_On_Nuxt_3/pages/index.vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./_nuxt/index.181bc589.mjs').then((m) => m.default || m)
  },
  {
    name: "products-id",
    path: "/products/:id",
    file: "/home/david/Programming/Personal/Store_On_Nuxt_3/pages/products/[id].vue",
    children: [],
    meta: meta$1,
    alias: (meta$1 == null ? void 0 : meta$1.alias) || [],
    component: () => import('./_nuxt/_id_.9c4e7f14.mjs').then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    file: "/home/david/Programming/Personal/Store_On_Nuxt_3/pages/products/index.vue",
    children: [],
    meta,
    alias: (meta == null ? void 0 : meta.alias) || [],
    component: () => import('./_nuxt/index.e6731dfe.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.a7f10a9c.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import('./_nuxt/default.640d7676.mjs').then((m) => m.default || m)),
  products: defineAsyncComponent(() => import('./_nuxt/products.5b0fac1e.mjs').then((m) => m.default || m))
};
...
export { _export_sfc as _, useRoute as a, __nuxt_component_0$2 as b, createError as c, useHead as d, entry$1 as default, __nuxt_component_0$1 as e, __nuxt_component_0$3 as f, useNuxtApp as u };
